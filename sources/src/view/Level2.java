...
public class Level2 extends ALevel {
    ...
    private ILevelBackground background;

    private ResetLevelButton resetButton;
    private MenuButton menuButton;

    private BlockFactory blockFactory;
    private IBlock object;
    ...
    public Level2() {
        ...
        playerInitialPosition = new Point(600, 100);
        background = new BackgroundImage2();
